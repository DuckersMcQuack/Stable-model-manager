#!/usr/bin/env python3
"""
Script to fix database paths by changing /mnt/user/ to /mnt/
"""
import sqlite3
import os
import sys

def fix_database_paths(db_path: str, old_prefix: str = "/mnt/user/", new_prefix: str = "/mnt/"):
...
if __name__ == "__main__":
    ...
    # Load config first to get database path
    config = configparser.ConfigParser()
    config.read('config.ini')
    
    # Get database path from config, fallback to command line arg or default
